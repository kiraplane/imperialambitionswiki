...
const retiredPublicRouteRedirects: Array<{
  ...
  { pattern: /^\/combat(?:\/.*)?$/, target: '/guides/battles-and-regiments' },
  {
    pattern: /^\/map(?:\/.*)?$/,
    target: '/guides/factions-maps-and-replayability',
  },
  ...
  {
    pattern: /^\/imperial-ambitions-beginner-guide(?:\/.*)?$/,
    target: '/guides/beginner-guide',
  },
  {
    pattern: /^\/imperial-ambitions-map(?:\/.*)?$/,
    target: '/guides/factions-maps-and-replayability',
  },
  {
    pattern: /^\/imperial-ambitions-download(?:\/.*)?$/,
    target: '/download',
  },
];
...
export default async function middleware(req: NextRequest) {
  ...
  const productionHosts = new Set([
    'imperialambitions.wiki',
    'www.imperialambitions.wiki',
  ]);
  const canonicalHost = 'www.imperialambitions.wiki';
