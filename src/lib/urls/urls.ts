...
export const CANONICAL_BASE_URL = 'https://www.imperialambitions.wiki';
...
function getImperialAmbitionsBaseUrl(url?: string) {
  ...
  try {
    ...
    if (
      parsedUrl.hostname === 'imperialambitions.wiki' ||
      parsedUrl.hostname === 'www.imperialambitions.wiki'
    ) {
...
export function getBaseUrl(): string {
  ...
  const imperialAmbitionsBaseUrl =
    getImperialAmbitionsBaseUrl(configuredBaseUrl);
  if (imperialAmbitionsBaseUrl) {
    return imperialAmbitionsBaseUrl;
  }
