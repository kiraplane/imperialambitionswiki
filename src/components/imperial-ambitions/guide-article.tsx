...
import type { Guide } from '@/data/imperial-ambitions/types';
...
export function GuideArticle({
  ...
  return (
    <div className="min-h-screen bg-[#091318] py-8 text-[#f6ecd2] md:py-10">
      ...
      <Container className="px-4">
        <div className="grid items-start gap-8 lg:grid-cols-[minmax(0,1fr)_272px]">
          <article className="min-w-0 space-y-6">
            <header className="overflow-hidden rounded-xl border border-[#31545b] bg-[#10242a]">
              <div className="relative aspect-[4/3] border-[#31545b] border-b sm:aspect-[16/7] sm:min-h-[220px]">
                <Image
                ...
                <div className="absolute inset-x-0 bottom-0 flex flex-wrap gap-2 p-5 md:p-7">
                  ...
                  <Badge
                    variant="outline"
                    className="border-[#63b7a9]/60 bg-[#091318]/80 text-[#f6ecd2]"
                  >
                  ...
                  {guide.tags.map((tag) => (
                    <Badge
                      key={tag}
                      variant="outline"
                      className="border-white/20 bg-[#091318]/80 text-[#f6ecd2]"
                    >
                      {tag}
                    </Badge>
                  ))}
              ...
              <div className="p-5 md:p-7">
                ...
                <p className="mt-4 text-sm leading-6 text-[#a9c0bc]">
            ...
            <div className="rounded-xl border border-[#31545b] bg-[#10242a] p-5 md:p-8">
                ...
                {guide.body.map((section, sectionIndex) => (
                  <div key={section.heading} className="space-y-8">
                    <section id={toSectionId(section.heading)}>
                      ...
                      <div className="mt-3 space-y-4 text-base leading-8 text-[#a9c0bc]">
                      ...
                      {section.bullets ? (
                        <ul className="mt-5 grid gap-2 text-sm leading-7 text-[#d7e3df]">
                          {section.bullets.map((bullet) => (
                            <li
                              key={bullet}
                              className="rounded-lg border border-[#31545b] bg-[#091318] px-4 py-3"
                            >
                              {bullet}
                            </li>
                          ))}
                    ...
                    {sectionIndex === 0 && guide.video ? (
                      <section className="overflow-hidden rounded-xl border border-[#31545b] bg-black">
                        <iframe
                          ...
                          allowFullScreen
                        />
                        <p className="bg-[#091318] px-4 py-3 text-sm leading-6 text-[#a9c0bc]">
                          {ui.videoPrefix}{' '}
                          <a
              ...
              <section className="mt-10 rounded-xl border border-[#31545b] bg-[#091318] p-5">
                <div className="flex gap-3">
                  <ShieldCheck className="mt-1 size-5 shrink-0 text-[#63b7a9]" />
                  <div>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="mt-3 inline-flex items-center gap-1 text-[#63b7a9] text-sm underline underline-offset-4"
                    >
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-2">
                  {guide.relatedRoutes.slice(0, 4).map((route) => (
                    <Button
                      ...
                      asChild
                      variant="outline"
                      className="h-auto min-w-0 justify-between gap-3 whitespace-normal border-[#31545b] bg-[#10242a] px-3 py-3 text-left text-[#f6ecd2] hover:border-[#63b7a9] hover:bg-[#17343a]"
                    >
                      <LocaleLink href={route}>
                        <span className="min-w-0 break-words">
                          {getRouteLabel(route)}
                        </span>
                        <ArrowRight className="size-4 shrink-0 text-[#63b7a9]" />
                      </LocaleLink>
                    </Button>
                  ))}
                </div>
