...
export function Footer({ className }: React.HTMLAttributes<HTMLElement>) {
  ...
  return (
    ...
    >
      ...
      <div className="border-[#31545b] border-t py-8">
        <Container className="px-4 flex items-center justify-between gap-x-4">
          ...
          <span className="text-muted-foreground text-sm">
            Independent Imperial Ambitions guide site. Not affiliated with
            aoiti, Electronic Sheep Games, Valve, Steam, Discord or YouTube.
          </span>
        </Container>
      </div>
    </footer>
