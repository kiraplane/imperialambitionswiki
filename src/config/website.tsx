...
export const websiteConfig: WebsiteConfig = {
  ...
  metadata: {
    images: {
      ogImage: '/imperial-ambitions/hero.jpg',
      logoLight: '/logo.svg',
      logoDark: '/logo.svg',
    },
    social: {
      ...
      twitter: '',
      blueSky: '',
      discord: 'https://discord.gg/NU963utpEb',
      mastodon: '',
      linkedin: '',
      youtube: 'https://www.youtube.com/@aoiti',
    },
  },
  features: {
  ...
  mail: {
    provider: 'resend',
    fromEmail: 'Imperial Ambitions Wiki <hello@imperialambitions.wiki>',
