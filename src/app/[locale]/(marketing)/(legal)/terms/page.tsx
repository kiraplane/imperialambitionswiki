...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: 'Terms of Service | Imperial Ambitions Wiki',
    description:
      'Terms for using Imperial Ambitions Wiki, an independent game guide site.',
    locale,
    pathname: '/terms',
  });
}
    ...
    <div className="bg-[#061018] py-12 text-[#EAF7FF]">
      <Container className="max-w-3xl space-y-6 px-4">
        ...
        <p className="leading-8 text-[#A8C7D8]">
          This site provides independent Imperial Ambitions guides, source
          notes, and official-link guidance. It is not affiliated with, endorsed
          by, sponsored by, or operated by aoiti and Electronic Sheep Games,
