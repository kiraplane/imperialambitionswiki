...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: 'Privacy Policy | Imperial Ambitions Wiki',
    description:
      'Privacy policy for Imperial Ambitions Wiki, an independent guide site.',
    locale,
    pathname: '/privacy',
  });
}
    ...
    <div className="bg-[#061018] py-12 text-[#EAF7FF]">
      <Container className="max-w-3xl space-y-6 px-4">
        ...
        <p className="leading-8 text-[#A8C7D8]">
          Imperial Ambitions Wiki is an independent guide site. We do not
          require accounts for browsing the wiki, platform pages, roster guides,
          deck guides, character notes, or official-link pages.
        </p>
        <p className="leading-8 text-[#A8C7D8]">
        ...
        <p className="leading-8 text-[#A8C7D8]">
          Privacy questions can be sent to hello@imperialambitions.wiki.
        </p>
      </Container>
    </div>
  );
