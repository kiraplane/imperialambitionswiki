...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: 'Cookie Policy | Imperial Ambitions Wiki',
    description:
      'How Imperial Ambitions Wiki uses essential cookies, analytics, and similar technologies.',
    locale,
    pathname: '/cookie',
  });
}
    ...
    <div className="bg-[#061018] py-12 text-[#EAF7FF]">
      <Container className="max-w-3xl space-y-6 px-4">
        ...
        <p className="leading-8 text-[#A8C7D8]">
          Imperial Ambitions Wiki uses essential cookies and similar
